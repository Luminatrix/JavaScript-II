...
// Problem 2 The Medium shirts were delivered with a typo! Better email
...
//Problem 3 We want to know what our runners do for work!
let companyNames = [];
runners.forEach(function(items) {
  return companyNames.push(
    `${items.first_name} ${items.last_name} ${items.company_name}`
  );
});
